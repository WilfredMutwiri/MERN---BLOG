        ...
        if(imageFile){
            const uploadImage=async()=>{
                ...
                uploadTasks.on(
                    ...
                    ()=>{
                        getDownloadURL(uploadTasks.snapshot.ref).then((downloadURL)=>setImageFileUrl(downloadURL)),
                        setImageFile(null)
                    }
                )
            }
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form className='flex flex-col gap-4'>
            ...
            <TextInput type='text' placeholder='userName' defaultValue={currentUser.userName} id='useName'/>
